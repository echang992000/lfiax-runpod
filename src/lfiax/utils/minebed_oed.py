...
def sdm_minebed(
    ...
    Args:
        ...
        GPYOPT_EPS: Minimum distance between consecutive BO suggestions before
            GPyOpt stops early. Use -np.inf to disable this stopping condition.
